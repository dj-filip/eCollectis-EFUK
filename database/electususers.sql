...
INSERT INTO `auth_user` (`id`, `password`, `last_login`, `is_superuser`, `username`, `first_name`, `last_name`, `email`, `is_staff`, `is_active`, `date_joined`) VALUES
	(1, 'pbkdf2_sha256$260000$f11EUHJhawheuiknN6TM3u$t8dIR5LpDF8D6zLpJVFL5SockijDtEKum95j+jI/4NY=', '2022-10-02 20:23:04.943187', 1, 'vlada', '', '', 'kocovic.vladimir@gmail.com', 1, 1, '2022-06-07 16:06:58.588105'),
	(2, 'pbkdf2_sha256$260000$5KOpIhwAx8JFgIFBjErBTh$as3aKSWmWCT0zZybj6cZZSyRQYUWeKpVi4iH63kQROQ=', '2023-03-07 20:05:27.259154', 1, 'admin', '', '', 'admin@fuk.com', 1, 1, '2022-06-24 06:12:32.840582'),
	(3, 'pbkdf2_sha256$260000$Ekcn8aZp32CEAmbo9cgsGI$1GthOXI6+GXarqvbr7zG5YLvRVGJAeeUsxmxLrz6NEI=', '2022-08-20 11:53:57.788836', 1, 'superadmin', '', '', 'super@admin.com', 1, 1, '2022-08-10 20:01:39.750862'),
	(4, 'pbkdf2_sha256$260000$TZFLn0Qn5mq9M62Bay4LF4$Ho5XBdFz9suQ6eUa6Qgfwv2rNydZMnLycX5X7YZnys4=', '2023-02-08 20:04:59.381280', 1, 'adminovic', '', '', 'admin@admin.rs', 1, 1, '2023-02-08 20:04:44.158458');
...
-- Dumping data for table electususers.django_admin_log: ~5 rows (approximately)
/*!40000 ALTER TABLE `django_admin_log` DISABLE KEYS */;
INSERT INTO `django_admin_log` (`id`, `action_time`, `object_id`, `object_repr`, `action_flag`, `change_message`, `content_type_id`, `user_id`) VALUES
	(1, '2022-06-07 16:26:42.315754', '1', 'FukAktivnost object (1)', 1, '[{"added": {}}]', 7, 1),
	(2, '2023-02-08 21:38:15.523710', '1', 'Who?', 1, '[{"added": {}}, {"added": {"name": "answer", "object": "Pitanje: Who?, odgovor: You"}}, {"added": {"name": "answer", "object": "Pitanje: Who?, odgovor: Me"}}, {"added": {"name": "answer", "object": "Pitanje: Who?, odgovor: She"}}]', 20, 4),
	(3, '2023-02-08 21:38:39.365768', '1', 'Who?', 2, '[{"changed": {"fields": ["Type"]}}]', 20, 4),
	(4, '2023-02-08 21:38:56.092155', '1', 'Godina: 2023-02-08, sekcija: 1, broj: 1, podbroj: 1, pitanje: Who?', 1, '[{"added": {}}]', 21, 4),
	(5, '2023-02-08 21:40:58.955195', '2', 'Godina: 2023-02-08, sekcija: 1, broj: 1, podbroj: 1, pitanje: Who?', 1, '[{"added": {}}]', 22, 4),
	(6, '2023-02-08 21:41:06.765360', '2', 'Godina: 2023-02-08, sekcija: 1, broj: 1, podbroj: 1, pitanje: Who?', 2, '[]', 22, 4);
...
-- Dumping data for table electususers.django_content_type: ~22 rows (approximately)
...
-- Dumping data for table electususers.django_migrations: ~56 rows (approximately)
...
INSERT INTO `django_migrations` (`id`, `app`, `name`, `applied`) VALUES
	...
	(24, 'fuk_aktivnost', '0001_initial', '2022-09-02 17:46:30.941012'),
	(25, 'fuk_gfuk', '0001_initial', '2022-09-02 17:46:30.953017'),
	(26, 'fuk_help', '0001_initial', '2022-09-02 17:46:30.959010'),
	(27, 'fuk_oblast', '0001_initial', '2022-09-02 17:46:30.964011'),
	(28, 'fuk_organizacija', '0001_initial', '2022-09-02 17:46:30.970013'),
	(29, 'fuk_orgjed', '0001_initial', '2022-09-02 17:46:30.976013'),
	(30, 'fuk_potpis', '0001_initial', '2022-09-02 17:46:30.982009'),
	(31, 'fuk_procedura', '0001_initial', '2022-09-02 17:46:30.988012'),
	(32, 'fuk_proces', '0001_initial', '2022-09-02 17:46:30.997011'),
	(33, 'fuk_proces_veza', '0001_initial', '2022-09-02 17:46:31.005015'),
	(34, 'fuk_rizik', '0001_initial', '2022-09-02 17:46:31.011012'),
	(35, 'fuk_riziks', '0001_initial', '2022-09-02 17:46:31.018040'),
	(36, 'fuk_aktivnost', '0002_alter_fukaktivnost_options', '2022-09-04 21:07:42.729313'),
	(37, 'fuk_gfuk', '0002_alter_fukgfuk_options', '2022-09-04 21:07:42.827309'),
	(38, 'fuk_help', '0002_alter_fukhelp_options', '2022-09-04 21:07:42.835337'),
	(39, 'fuk_oblast', '0002_alter_fukoblast_options', '2022-09-04 21:07:42.841334'),
	(40, 'fuk_organizacija', '0002_alter_fukorganizacija_options', '2022-09-04 21:07:42.847335'),
	(41, 'fuk_orgjed', '0002_alter_fukorgjed_options', '2022-09-04 21:07:42.855333'),
	(42, 'fuk_potpis', '0002_alter_fukpotpis_options', '2022-09-04 21:07:42.861313'),
	(43, 'fuk_procedura', '0002_alter_fukprocedura_options', '2022-09-04 21:07:42.869310'),
	(44, 'fuk_proces', '0002_alter_fukproces_options', '2022-09-04 21:07:42.882313'),
	(45, 'fuk_proces_veza', '0002_alter_fukprocesveza_options', '2022-09-04 21:07:42.896313'),
	(46, 'fuk_rizik', '0002_alter_fukrizik_options', '2022-09-04 21:07:42.904311'),
	(47, 'fuk_riziks', '0002_alter_fukriziks_options', '2022-09-04 21:07:42.910310'),
	(48, 'fuk_aktivnost', '0003_auto_20220904_2308', '2022-09-04 21:08:48.314043'),
	(49, 'fuk_gfuk', '0003_alter_fukgfuk_org_id', '2022-09-04 21:08:48.329048'),
	(50, 'fuk_oblast', '0003_alter_fukoblast_org_id', '2022-09-04 21:08:48.342046'),
	(51, 'fuk_orgjed', '0003_alter_fukorgjed_org_id', '2022-09-04 21:08:48.356044'),
	(52, 'fuk_procedura', '0003_auto_20220904_2308', '2022-09-04 21:08:48.421043'),
	(53, 'fuk_proces', '0003_auto_20220904_2308', '2022-09-04 21:08:48.461041'),
	(54, 'fuk_proces_veza', '0003_auto_20220904_2308', '2022-09-04 21:08:48.494042'),
	(55, 'fuk_rizik', '0003_auto_20220904_2308', '2022-09-04 21:08:48.540041'),
	(56, 'fuk_riziks', '0003_auto_20220904_2308', '2022-09-04 21:08:48.577043'),
	(57, 'fuk_nepravilnosti', '0001_initial', '2022-11-14 19:18:27.699760'),
	(58, 'question', '0001_initial', '2023-02-08 20:55:12.034305'),
	(59, 'question', '0002_alter_quiz_year', '2023-03-10 21:17:34.633931');
...
-- Dumping data for table electususers.django_session: ~9 rows (approximately)
/*!40000 ALTER TABLE `django_session` DISABLE KEYS */;
INSERT INTO `django_session` (`session_key`, `session_data`, `expire_date`) VALUES
	('7oa36py1amq57gbvvks8nylmyjl35629', '.eJxVjMsOwiAQRf-FtSEwA0zr0r3fQIaHUjWQlHZl_HdD0oVu7znnvoXnfSt-73n1SxJnAeL0uwWOz1wHSA-u9yZjq9u6BDkUedAury3l1-Vw_w4K9zJqhKiRkSEESgTBYgbL5GieorqhpezU5JSeCS1oMhyyTayJHRpgIz5fzyo3AA:1oUAK3:VsoX1sbbENRK14aXV189pSG73mAV0O3dk_pRB-SmqnE', '2022-09-03 03:19:15.389042'),
