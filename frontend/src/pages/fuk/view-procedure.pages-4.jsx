...
const ViewProcedure4 = (props) => {
  ...
  <Grid container direction="column"  className="opacity-txt-box">
    <Typography variant="h4" >Друга документација</Typography>
    <Typography variant="h3">{drugaDokumentacija}</Typography>
  </Grid>
  )
}

export default ViewProcedure4