...
const UpdateProcess6 = (props) => {
  const { 
    resursiZaOstvarivanjePoslovnogProcesa,
    setResursiZaOstvarivanjePoslovnogProcesa
  } = props
  ...
  return (
    <Grid container direction="column"  className="opacity-txt-box">
      <TextField
        ...
        value={resursiZaOstvarivanjePoslovnogProcesa}
        onChange={(e) => {
          setResursiZaOstvarivanjePoslovnogProcesa(e.target.value)
        }}
      />  
    </Grid>
  )
