...
const ViewProcedure7 = (props) => {
  ...
  return (
    ...
    <Typography variant="h4" >Појмови и скраћенице које се користе у дијаграму тока</Typography>
    <Typography variant="h3">{pojmovi}</Typography>
  </Grid>
  )
}

export default ViewProcedure7