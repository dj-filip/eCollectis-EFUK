...
const ViewProcess3 = (props) => {
  ...
  return (
    <Grid container direction="column" className="opacity-txt-box">
      <Typography variant="h4" >Основни ризици</Typography>
      {glavniRizici?.map((risk) => {
        return (
        <Typography variant="h3" display="block" >{risk}</Typography>
      );
      })}
    </Grid>
  )
