...
const ViewProcess4 = (props) => {
  ...
  return (
    <Grid container direction="column"  className="opacity-txt-box">
        <Typography variant="h4">Кратак опис процеса</Typography>
      <Stack spacing={4}>
        <Typography variant="h3">УЛАЗ: {kratakOpisUlaza}</Typography>
        <Typography variant="h3">АКТИВНОСТИ: {kratakOpisAktivnosti}</Typography>
        <Typography variant="h3">ИЗЛАЗ: {kratakOpisRezultata}</Typography>
      </Stack>
    </Grid>
  )
}

export default ViewProcess4