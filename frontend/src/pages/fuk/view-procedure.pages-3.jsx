...
const ViewProcedure3 = (props) => {
  ...
  <Grid container direction="column"  className="opacity-txt-box">
    <Typography variant="h4" >Подручје примене</Typography>
    <Typography variant="h3">{podrucjePrimene}</Typography>
  </Grid>
  )
}

export default ViewProcedure3