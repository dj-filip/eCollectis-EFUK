...
const ViewProcedure6 = (props) => {
  ...
  <Grid container direction="column"  className="opacity-txt-box">
    <Typography variant="h4" >Законски и подзаконски оквир</Typography>
    <Typography variant="h3">{zakonskiOkvir}</Typography>
  </Grid>
  )
}

export default ViewProcedure6